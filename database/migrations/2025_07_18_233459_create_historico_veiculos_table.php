...
return new class extends Migration
{
    ...
    public function up(): void
    {
        Schema::create('historico_veiculos', function (Blueprint $table) {
            ...
            $table->integer('id_veiculo_substituto')->unsigned()->nullable()->comment('Chave estrangeira para veículo reserva que ira substituir');
            ...
            $table->time('hora_conclusao')->nullable()->comment('Hora de retorno do veiculo');
